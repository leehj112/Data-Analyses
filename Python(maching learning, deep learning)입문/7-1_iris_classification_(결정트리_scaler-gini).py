# -*- coding: utf-8 -*-
"""
Created on Thu Jul 11 10:21:20 2024
...
# MSE(Mean Squared Error, 평균제곱오차)를 구해서 가장 낮은 MSE 값이 나오도록 노드를 분류
#
...
print("Accuracy: %.4f" % dtc_acc) # 0.9333
...
plot_tree(dtc, fontsize=20, feature_names=x_cols, filled=True)
plt.show()