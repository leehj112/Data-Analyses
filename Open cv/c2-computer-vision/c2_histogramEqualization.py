# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 12:10:06 2024
...
# 명암비 조절 : Look Up Table
res2 = cv2.LUT(img1, multi_lut)  # 상수곱
res3 = cv2.LUT(img1, log_lut)    # 로그
res4 = cv2.LUT(img1, invol1_lut) # 거듭제곱
...
for (name, out) in display_img:
    cv2.imshow(name, out)   # 화면출력
    cv2.imwrite(save_dir + "/" + name + ".jpg", out) # 파일저장
