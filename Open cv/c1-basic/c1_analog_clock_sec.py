# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 10:48:38 2024
...
while(True):
    ...
    if(sec == 0 or 1 <= hour <= 14):
        x_pos = int(220.0*cos((90-Ang_Sec)*3.141592 /180))
        y_pos = int(220.0*sin((90-Ang_Sec)*3.141592 /180))
        cv2.line(img, (256, 256), (256 + x_pos, 256 - y_pos), (0, 0, 255), 2)
    elif(15<= hour <= 29):
        x_pos = int(220.0*cos((Ang_Sec-90)*3.141592 /180))
        y_pos = int(220.0*sin((Ang_Sec-90)*3.141592 /180))
        cv2.line(img, (256, 256), (256 + x_pos, 256 + y_pos), (0, 0, 255), 2)
    elif(30<= hour <= 44):
        x_pos = int(220.0*cos((Ang_Sec-180)*3.141592 /180))
        y_pos = int(220.0*sin((Ang_Sec-180)*3.141592 /180))
        cv2.line(img, (256, 256), (256 - x_pos, 256 + y_pos), (0, 0, 255), 2)
    elif(45<= hour <= 59):
        x_pos = int(220.0*cos((Ang_Sec-270)*3.141592 /180))
        y_pos = int(220.0*sin((Ang_Sec-270)*3.141592 /180))
        cv2.line(img, (256, 256), (256 - x_pos, 256 - y_pos), (0, 0, 255), 2)
