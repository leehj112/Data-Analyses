# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 09:08:17 2024
...
# voting
#   - 'hard' : 다수결로 최종 분류 결정
#   - 'soft' : 예측확률을 합산하여 가장 높은 확률

# 전달되는 인자는 튜플(이름, 모델객체)
# from sklearn.ensemble import VotingClassifier
# VotingClassifier(estimators=[('KNN', knn), ('LGR', lrc), ('DT', dtc)], voting='soft')
...
# y_svc_prob = svc.predict_proba(X_test)
# print("[svc] y_svc_prob:")
# print(y_svc_prob)
...
# Soft Voting 모델 학습 및 예측
# voting='soft' : 평균으로 최종 분류 결정
# estimators: knn, svc, dtc
from sklearn.ensemble import VotingClassifier

# svc(SVM) -> lrc(로지스틱 회귀)
hvc = VotingClassifier(estimators=[('KNN', knn), ('LGR', lrc), ('DT', dtc)], voting='soft')
