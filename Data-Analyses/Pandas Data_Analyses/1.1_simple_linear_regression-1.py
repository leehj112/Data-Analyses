# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 11:36:52 2024
...
print(round(df.describe(), 2)) # 소수점 2자리 출력
print('\n')

#%%
# horsepower 열의 자료형 변경 (문자열 ->숫자)
# horsepower 열의 고유값 확인
horsepower = df['horsepower'].unique()
print(len(horsepower), '건')     
print(horsepower)

#%%

horsepower_sorted = sorted(horsepower)     
...
print('훈련 data 개수: ', len(X_train)) # 274
print('검증 data 개수: ', len(X_test))  # 118
...
# R² = 1 - ((타깃 - 예측)² / (타깃 - 평균)²)
# R² = SSR / SST
# SSE(Sum of Squares Error) : 타깃 - 예측
# SSR(Sum of Regression)    : 평균 - 예측
