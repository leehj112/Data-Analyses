# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 12:13:33 2024
...
sns.scatterplot(x="Milk", y="Delicassen", data=ndf)

#%%
sns.scatterplot(x="Milk", y="Delicassen", data=ndf, hue="Cluster", palette="rainbow")