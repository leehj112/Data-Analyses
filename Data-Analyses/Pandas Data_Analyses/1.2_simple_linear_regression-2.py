# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 11:37:46 2024
...
#%%
# 'model year' 열의 고유값 확인
model_year = sorted(list(df['model year'].unique()), reverse=True)
print('model year:', model_year)
print('\n')

#%%

horsepower_q = df[df['horsepower'] == '?']
horsepower_nan = df[df['horsepower'] == np.nan]

df_nan = df[df.isnull().any(axis=1)]


#horsepower_q2 = df[horsepower_q.any(axis=1)]
