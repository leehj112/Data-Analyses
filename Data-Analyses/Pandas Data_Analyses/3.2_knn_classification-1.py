# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 11:43:00 2024
...
# 교재 : P316
# 교재설명과 confusion_matrix의 결과가 knn_matrix 일치하지 않음
TP = knn_matrix[0,0]
FP = knn_matrix[0,1]
FN = knn_matrix[1,0]
TN = knn_matrix[1,1]
...
precision = TP / (TP + FP)
print("precision: ", precision) # 0.88

# 재현율(recall) = TP / (TP + FN)
recall = TP / (TP + FN)
recall = round(recall, 2) 
print("recall: ", recall) # 0.81

# F1 지표 = (2 * (recision * recall)) / (precision + recall)
F1_score = (2 * (precision * recall)) / (precision + recall)
F1_score = round(F1_score, 2) 
print("F1_score:", F1_score) # 0.84